...
set "MACRO_NAME=QCOM_USERSPACE_DRIVERS_VERSION"
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "!ATTEST_SCRIPT!" -ProductName "QCOM_USERSPACE_DRIVERS_VERSION_!VERSION!_EXT" -InputPath "!CAB_PATH!"
if !ERRORLEVEL! neq 0 (
